...
.. Run the command `wget http://www.opentlc.com/rhte-na/labkey`.
.. Test the connection via the command `ssh -i /path_to_key/labkey root@workstation-<GUID>.rhpds.opentlc.com`
